...
const BackButton = ({ href, label = "Home" }: BackButtonProps) => {
    return (
        <Link href={href}>
            <Button 
                variant="ghost" 
                className="min-w-20 px-3 py-2 bg-stone-500 rounded-md border-b-[2.40px] border-zinc-400 inline-flex justify-center items-center overflow-hidden gap-2 cursor-pointer"
            >
